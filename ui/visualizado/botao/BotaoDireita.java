...
public class BotaoDireita extends BotaoPrincipal{ 
	public BotaoDireita(String posicao, Tabuleiro tabuleiro, 
		...
		@Override
		public void actionPerformed(ActionEvent event) { // Altera o tabuleiro para o movimento da direita
